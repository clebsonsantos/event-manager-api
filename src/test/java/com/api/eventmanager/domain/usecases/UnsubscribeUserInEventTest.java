...
public class UnsubscribeUserInEventTest {

  @Autowired
  UnsubscribeUserInEvent sut;
  ...
  public void mocks() {
    ...
    this.sut = new UnsubscribeUserInEventImpl(eventRepository, userRepository);
  }

  @Test
  public void shouldBeUnsubscribeUserEvent() throws NotFoundException{
